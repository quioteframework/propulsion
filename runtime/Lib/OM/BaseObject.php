 ...
 * @method     array|string toArray(string $keyType = BasePeer::TYPE_PHPNAME, ?bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = array(), bool $includeForeignObjects = false) Generated by ObjectBuilder::addToArray() -- only for tables where isAddGenericAccessors() is true (see the comment above getPrimaryKey()/clearAllReferences() below for why this isn't a real `abstract` method).
 * @method     void fromArray(array $arr, string $keyType = BasePeer::TYPE_PHPNAME) Generated by ObjectBuilder::addFromArray() -- only for tables where isAddGenericMutators() is true (see the comment above getPrimaryKey()/clearAllReferences() below for why this isn't a real `abstract` method).
