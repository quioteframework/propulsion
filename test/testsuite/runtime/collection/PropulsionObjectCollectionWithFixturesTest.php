...
class PropulsionObjectCollectionWithFixturesTest extends BookstoreEmptyTestBase
{
	...
	public function testFromArray()
	{
		...
		$author->save();
		$books = array(
			array('Title' => 'Mansfield Park', 'ISBN' => '9780141439808', 'AuthorId' => $author->getId()),
			array('Title' => 'Pride And PRejudice', 'ISBN' => '9780141439518', 'AuthorId' => $author->getId())
		);
	...
	public function testPopulateRelation()
	{
		...
		$this->assertTrue($books instanceof PropulsionObjectCollection, 'populateRelation() returns a PropulsionCollection instance');
