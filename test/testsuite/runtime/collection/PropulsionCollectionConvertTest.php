...
class PropulsionCollectionConvertTest extends BookstoreTestBase
{
	...
	protected function setUp(): void
	{
		...
		$this->coll = new PropulsionObjectCollection();
...
EOF;
	...
	{
		$this->assertEquals($expected, (string) $this->coll, 'PropulsionCollection::__toString() uses the YAML representation by default');
	}
