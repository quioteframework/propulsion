...
class PropulsionDateTimeTest extends TestCase
{
	...
	public function testConstruct()
	{
		...
		$dt = new DateTime($now);
		$pdt = new PropulsionDateTime($now);
		$this->assertDatesEqual($dt, $pdt, "Expected DateTime == PropulsionDateTime: %s");

		$dt = new DateTime($now, new DateTimeZone('UTC'));
		$pdt = new PropulsionDateTime($now, new DateTimeZone('America/New_York'));
		$this->assertDatesNotEqual($dt, $pdt, "Expected DateTime != PropulsionDateTime: %s");

	}

	/**
	 * Tests the ability to serialize() a PropulsionDateTime object.
	 */
	...
	public function testNewInstanceInvalidValue()
	{
		...
		$dt = PropulsionDateTime::newInstance('some string');
	}
