...
class PropulsionModelPagerTest extends BookstoreEmptyTestBase
{
	...
	public function testGetResults()
	{
		$this->createBooks(5);
		$pager = $this->getPager(4, 1);
		$this->assertTrue($pager->getResults() instanceof PropulsionObjectCollection, 'getResults() returns a PropulsionObjectCollection');
	...
	public function testGetResultsRespectsFormatter()
	{
		...
		$pager = new PropulsionModelPager($query, 4);
		$pager->setPage(1);
		$pager->init();
		$this->assertTrue($pager->getResults() instanceof PropulsionArrayCollection, 'getResults() returns a PropulsionArrayCollection if the query uses array hydration');
	}
