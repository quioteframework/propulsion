...
class ModelCriteriaSelectTest extends BookstoreTestBase
{
	...
	public function testSelectStringNoResult()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(string) selects a single column');
	...
	public function testSelectStringAcceptsColumnNames()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'select() accepts short column names');

		$c = new ModelCriteria('bookstore', 'Book');
		$c->select('Book.Title');
		$titles = $c->find();
		$expectedSQL = 'SELECT book.TITLE AS "Book.Title" FROM book';
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'select() accepts complete column names');

		$c = new ModelCriteria('bookstore', 'Book', 'b');
		$c->select('b.Title');
		$titles = $c->find();
		$expectedSQL = 'SELECT book.TITLE AS "b.Title" FROM book';
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'select() accepts complete column names with table aliases');
	}
	...
	public function testSelectStringFind()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(string) allows for where() statements');
	}
	...
	public function testSelectStringFindOne()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'findOne() called after select(string) selects a single column and requests a single row');
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'findOne() called after select(string) allows for where() statements');
	}
	...
	public function testSelectStringJoin()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(string) allows for join() statements');
	...
	public function testSelectStringWildcard()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'select(\'*\') selects all the columns from the main object');
	...
	public function testSelectArrayFind()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(array) allows for where() statements');
	}
	...
	public function testSelectArrayFindOne()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'findOne() called after select(array) allows for where() statements');
	}
	...
	public function testSelectArrayJoin()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(array) allows for join() statements');
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'findOne() called after select(array) allows for join() statements');
	...
	public function testSelectArrayRelation()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'select(array) can select columns from several tables (many-to-one)');
	...
	public function testSelectArrayWithColumn()
	{
		...
		$this->assertEquals($expectedSQL, normalizeGeneratedSql($this->con->getLastExecutedQuery()), 'find() called after select(array) can cope with a column added with withColumn()');
