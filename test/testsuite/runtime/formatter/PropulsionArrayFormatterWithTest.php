...
class PropulsionArrayFormatterWithTest extends BookstoreEmptyTestBase
{
	...
	public function testFindOneWithColumn()
	{
		...
		$this->assertEquals('Gunter', $book['AuthorName'], 'PropulsionArrayFormatter adds withColumns as columns');
		$this->assertEquals('Grass', $book['AuthorName2'], 'PropulsionArrayFormatter correctly hydrates all as columns');
	}
	...
	public function testFindOneWithClassAndColumn()
	{
		...
		$this->assertEquals('The Tin Drum', $book['Title']);
		$this->assertEquals('Gunter', $book['Author']['FirstName'], 'PropulsionArrayFormatter correctly hydrates withclass and columns');
		$this->assertEquals('Gunter', $book['AuthorName'], 'PropulsionArrayFormatter adds withColumns as columns');
		$this->assertEquals('Grass', $book['AuthorName2'], 'PropulsionArrayFormatter correctly hydrates all as columns');
	}
