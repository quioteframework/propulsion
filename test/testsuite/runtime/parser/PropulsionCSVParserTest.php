...
/**
 * Test for PropulsionCSVParser class
 *
 * @author     Francois Zaninotto
 * @package    runtime.parser
 */
class PropulsionCSVParserTest extends TestCase
{
	...
	{
		$parser = new PropulsionCSVParser();
		$this->assertEquals($csvData, $parser->fromArray($arrayData), 'PropulsionCSVParser::fromArray() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionCSVParser();
		$this->assertEquals($csvData, $parser->toCSV($arrayData), 'PropulsionCSVParser::toCSV() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionCSVParser();
		$this->assertEquals($arrayData, $parser->toArray($csvData), 'PropulsionCSVParser::toArray() converts to ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionCSVParser();
		$this->assertEquals($arrayData, $parser->fromCSV($csvData), 'PropulsionCSVParser::fromCSV() converts to ' . $type . ' correctly');
	}
