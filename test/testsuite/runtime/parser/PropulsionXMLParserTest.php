...
/**
 * Test for PropulsionXMLParser class
 *
 * @author     Francois Zaninotto
 */
class PropulsionXMLParserTest extends TestCase
{
...
", 'keys with numbers'),
	...
	{
		$parser = new PropulsionXMLParser();
		$this->assertEquals($xmlData, $parser->fromArray($arrayData), 'PropulsionXMLParser::fromArray() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionXMLParser();
		$this->assertEquals($xmlData, $parser->toXML($arrayData), 'PropulsionXMLParser::toXML() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionXMLParser();
		$this->assertEquals($arrayData, $parser->toArray($xmlData), 'PropulsionXMLParser::toArray() converts to ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionXMLParser();
		$this->assertEquals($arrayData, $parser->fromXML($xmlData), 'PropulsionXMLParser::fromXML() converts to ' . $type . ' correctly');
	}
