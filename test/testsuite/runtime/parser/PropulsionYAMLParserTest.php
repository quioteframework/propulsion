...
/**
 * Test for PropulsionYAMLParser class
 *
 * @author     Francois Zaninotto
 */
class PropulsionYAMLParserTest extends TestCase
{
...
", 'keys with numbers'),
	...
	{
		$parser = new PropulsionYAMLParser();
		$this->assertEquals($YAMLData, $parser->fromArray($arrayData), 'PropulsionYAMLParser::fromArray() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionYAMLParser();
		$this->assertEquals($YAMLData, $parser->toYAML($arrayData), 'PropulsionYAMLParser::toYAML() converts from ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionYAMLParser();
		$this->assertEquals($arrayData, $parser->toArray($YAMLData), 'PropulsionYAMLParser::toArray() converts to ' . $type . ' correctly');
	}
	...
	{
		$parser = new PropulsionYAMLParser();
		$this->assertEquals($arrayData, $parser->fromYAML($YAMLData), 'PropulsionYAMLParser::fromYAML() converts to ' . $type . ' correctly');
	}
