...
CREATE OR REPLACE TRIGGER foo5_TRG
BEFORE INSERT ON foo5
FOR EACH ROW
WHEN (new.id IS NULL)
BEGIN
	SELECT foo5_SEQ.NEXTVAL INTO :new.id FROM dual;
END;
...
";
	...
	{
		$expected = "
ALTER TABLE foo MODIFY bar BINARY_DOUBLE;
";
...
(
	bar1 NUMBER,
	bar2 BINARY_DOUBLE DEFAULT -1 NOT NULL
);
";
