 ...
 *
 */
class PropulsionColumnComparatorTest extends TestCase
{
	protected $platform;
	...
	public function testCompareNoDifference()
	{
		...
		$this->assertEquals(array(), PropulsionColumnComparator::compareColumns($c1, $c2));
	}
	...
	public function testCompareType()
	{
		...
		$this->assertEquals($expectedChangedProperties, PropulsionColumnComparator::compareColumns($c1, $c2));
	}
