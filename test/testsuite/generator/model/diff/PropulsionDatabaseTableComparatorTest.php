...
class PropulsionDatabaseTableComparatorTest extends TestCase
{
	...
	public function testCompareSameTables()
	{
		...
		$this->assertFalse(PropulsionDatabaseComparator::computeDiff($d1, $d2));
	}
	...
	public function testCompareNotSameTables()
	{
		...
		$this->assertTrue($diff instanceof PropulsionDatabaseDiff);
	}
	...
	public function testCompareCaseInsensitive()
	{
		...
		$this->assertFalse(PropulsionDatabaseComparator::computeDiff($d1, $d2, true));
	}
	...
	public function testCompareAddedTable()
	{
		...
		$dc = new PropulsionDatabaseComparator();
	...
	public function testCompareModifiedTable()
	{
		...
		$tableDiff = PropulsionTableComparator::computeDiff($t1, $t3);
