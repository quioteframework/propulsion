...
/**
 * Tests for the Column methods of the PropulsionTableComparator service class.
 *
 * @package    generator.model.diff
 */
class PropulsionTableColumnComparatorTest extends TestCase
{
	protected $platform;
	...
	public function testCompareSameColumns()
	{
		...
		$this->assertFalse(PropulsionTableComparator::computeDiff($t1, $t2));
	}
	...
	public function testCompareNotSameColumns()
	{
		...
		$diff = PropulsionTableComparator::computeDiff($t1, $t2);
		$this->assertTrue($diff instanceof PropulsionTableDiff);
	}
	...
	public function testCompareCaseInsensitive()
	{
		...
		$this->assertFalse(PropulsionTableComparator::computeDiff($t1, $t2, true));
	}
	...
	public function testCompareSeveralColumnDifferences()
	{
		...
		$columnDiff = PropulsionColumnComparator::computeDiff($c1, $c4);
