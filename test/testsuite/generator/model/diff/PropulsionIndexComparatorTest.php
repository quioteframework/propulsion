...
/**
 * Tests for the PropulsionColumnComparator service class.
 *
 */
class PropulsionIndexComparatorTest extends TestCase
{
	public function testCompareNoDifference()
	{
		...
		$i2->addColumn($c2);
		$this->assertFalse(PropulsionIndexComparator::computeDiff($i1, $i2));
	...
	public function testCompareCaseInsensitive()
	{
		...
		$i2 = new Index('fOO_iNDEX');
		$i2->addColumn($c2);
		$this->assertFalse(PropulsionIndexComparator::computeDiff($i1, $i2, true));
	}
	...
	public function testCompareType()
	{
		...
		$i2->addColumn($c2);
		$this->assertTrue(PropulsionIndexComparator::computeDiff($i1, $i2));
	}
