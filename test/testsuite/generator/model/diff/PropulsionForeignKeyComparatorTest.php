...
class PropulsionForeignKeyComparatorTest extends TestCase
{
	public function testCompareNoDifference()
	{
		...
		$this->assertFalse(PropulsionForeignKeyComparator::computeDiff($fk1, $fk2));
	}
	...
	public function testCompareCaseInsensitive()
	{
		...
		$t2 = new Table('bAZ');
		$t2->addForeignKey($fk2);
		$this->assertFalse(PropulsionForeignKeyComparator::computeDiff($fk1, $fk2, true));
	}
	...
	public function testCompareLocalColumn()
	{
		...
		$t2 = new Table('Baz');
		$t2->addForeignKey($fk2);
		$this->assertTrue(PropulsionForeignKeyComparator::computeDiff($fk1, $fk2));
	}
