...
return [
    ...
    // Read from the runtime constant rather than repeated as a literal -- see
    // Propulsion::VERSION. This value is stamped into every generated file's
    // header ("autogenerated by Propulsion X on: ..."), and it silently said
    // 2.1.0 through the 2.1.1 release and into 3.0 because bumping it is a
    // separate step nobody remembers.
    'propulsion.version' => \Propulsion\Propulsion::VERSION,
