 ...
 */
class PropulsionSchemaReverseTask extends PDOTask
{
	 ...
	 * @var        int
	 */
	protected $validatorBits = PropulsionSchemaReverseTask::VALIDATORS_NONE;
	...
	static protected $validatorBitMap = array (
		'none' => PropulsionSchemaReverseTask::VALIDATORS_NONE,
		'maxlength' => PropulsionSchemaReverseTask::VALIDATORS_MAXLENGTH,
		'maxvalue' => PropulsionSchemaReverseTask::VALIDATORS_MAXVALUE,
		'type' => PropulsionSchemaReverseTask::VALIDATORS_TYPE,
		'required' => PropulsionSchemaReverseTask::VALIDATORS_REQUIRED,
		'unique' => PropulsionSchemaReverseTask::VALIDATORS_UNIQUE,
		'all' => PropulsionSchemaReverseTask::VALIDATORS_ALL,
	);
	...
	protected function addValidators(Database $database)
	{
		...
		foreach ($database->getTables() as $table) {
			...
			$set = new PropulsionSchemaReverse_ValidatorSet();
			...
			foreach ($table->getColumns() as $col) {
				...
				if (in_array($col->getType(), array(PropulsionTypes::CHAR, PropulsionTypes::VARCHAR, PropulsionTypes::LONGVARCHAR))
 ...
 * @package    propel.generator.task
 */
class PropulsionSchemaReverse_ValidatorSet
{
