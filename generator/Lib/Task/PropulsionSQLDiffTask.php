 ...
 */
class PropulsionSQLDiffTask extends AbstractPropulsionDataModelTask
{
	...
	public function main()
	{
		...
		foreach ($ad->getDatabases() as $database) {
			...
			$databaseDiff = PropulsionDatabaseComparator::computeDiff($database, $appDataFromXml->getDatabase($name), $this->isCaseInsensitive());
