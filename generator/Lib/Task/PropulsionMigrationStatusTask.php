 ...
 */
class PropulsionMigrationStatusTask extends BasePropulsionMigrationTask
{
	public function main()
	{
		...
		// the following is a verbose version of PropulsionMigrationManager::getValidMigrationTimestamps()
