 ...
 */
class PropulsionConvertConfTask extends AbstractPropulsionDataModelTask
{
	 ...
	 * The directory is specified using AbstractPropulsionDataModelTask#setOutputDirectory().
	 * @param      string $outputFile
	 * @see        AbstractPropulsionDataModelTask#setOutputDirectory()
	 */
	...
	public function main()
	{
		...
		$output = "<?php\n";
		$output .= "// This file generated by Propulsion " . $phpconf['generator_version'] . " convert-conf target".($this->getGeneratorConfig()->getBuildProperty('addTimestamp') ? " on " . strftime("%c") : '') . "\n";
			...
			foreach ($dataModel->getDatabases() as $database) {
				...
				foreach ($database->getTables() as $table) {
					...
					if (!$table->isForReferenceOnly()) {
						...
						// -----------------------------------------------------
						// (this code is based on PropulsionOMTask)
