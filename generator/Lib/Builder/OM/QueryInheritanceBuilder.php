...
";
	...
	protected function addFactory(&$script)
	{
		...
		// The base BaseXxxQuery class this stub extends may have been generated by
		// PHP84QueryBuilder, which declares a typed create(?string, ?Criteria): self
		// signature -- match it, or PHP fatals on an incompatible override. The plain
		// (PHP5-targeted) QueryBuilder leaves create() untyped, so match that instead
		// when this isn't a PHP84 build.
		$isPhp84 = $this->getGeneratorConfig()
			&& $this->getGeneratorConfig()->getBuildProperty('targetPlatform') === 'php84';
		$signature = $isPhp84
