...
abstract class ".$this->getClassname()." extends " . $parentClass . "
{
    ...
    public function getUseStatements($ignoredNamespace = null)
    {
        ...
        // any PropelQuickBuilder-built schema): no `namespace` statement of its own, so bare
        // core-class references already resolve via the global alias above with no import
        // needed -- and PropelQuickBuilder concatenates many such classes into a single
